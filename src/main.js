import './style.css'
import { fromEvent, styleRange, toggleTheme } from './utils/utils'
...
document.querySelector('#app').innerHTML = `
  <div class="flex items-center flex-col justify-center gap-12 p-10 rounded-[60px] bg-gray-900/20 backdrop-blur-3xl shadow-xl/40 shadow-gray-700 font-sans text-white dark:text-blue-300 transition-all duration-500">
    ...
    <section class="min-h-10 min-w-3xs bg-orange-300/40 dark:bg-gray-500/40 shadow-lg shadow-orange-500/20 dark:shadow-gray-500/70 rounded-2xl transition-all duration-500">
      <div class="lg:min-h-10 min-w-xl flex justify-around p-6">
        ...
        <section class="flex gap-4">
          <button class="p-2 rounded-2xl bg-orange-300/40 dark:bg-blue-300/40 text-white cursor-pointer hover:scale-90 transition-all">Copy</button>
    ...
    <section class="link_info p-2 flex flex-row dark:opacity-100">
      <a class="cursor-pointer rounded-full dark:bg-gray-600/40 p-2 bg-orange-600/40 transition-colors">
...
//TODO: MEJORAR TEMA VISUAL DEL GITHUB, AÑADIR EL TOGGLE DE THEME, Y BUSCAR SITIO MEJOR PARA EL TOGGLE